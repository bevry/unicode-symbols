...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/unicode-symbols@^7.0.1'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/unicode-symbols@^7.0.1'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/unicode-symbols@7.0.1'
</script>
```
